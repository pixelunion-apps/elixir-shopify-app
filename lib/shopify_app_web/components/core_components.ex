defmodule ShopifyAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShopifyAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShopifyAppWeb.Gettext, "errors", msg, opts)
    end
  end
